...
insert into users(name, email, created_at, Summary) values ('Avery Wong', 'fake@gmail.com', NOW(),'UCLA CS/Math Grad Dec 2017 | Software Engineer, Data | C/C++, SQL, Golang, JavaScript, C# | Visual Studio, Linux, Shell, Node.js, Express.js, React.js, PostgreSQL, MS SQL, Docker | ETL, Automation, Databases, Web Backend | Gopher | https://github.com/hashsequence');
